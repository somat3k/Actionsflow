...
class _FakeGeminiOrchestratorOK:
    """Fake GeminiOrchestrator that always returns a valid analysis response."""
...
def test_health_check_all_ok(monkeypatch):
    ...
    assert set(by_name) == {"Gemini", "OpenRouter", "OpenAI", "Groq"}
